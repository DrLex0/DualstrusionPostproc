...
The script will keep a copy of the unprocessed code as a copy with “_orig” appended to the name. This allows to manually run the script again with different settings in case you want to change something without re-exporting the G-code file from Slic3r.
...
## Notes
The script is specifically written for Slic3r, but it might be usable for other slicers (like Simplify3D) with relatively small changes. Contributions to make the script usable with other slicers are welcome!
